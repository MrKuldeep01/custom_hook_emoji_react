...
const Card = ({data}) => {
    ...
    <span className='font-mono text-xl p-4 text-center bg-black/10 w-full rounded-xl hidden sm:inline'>
    ...
    <span className='font-mono text-xl p-4 text-center w-full bg-black/10 rounded-xl hidden sm:inline'>
